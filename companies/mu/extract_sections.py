...
Reusable across companies -- just change RAW_DIR, OUT_DIR, YEARS, and filename pattern.
"""
import re
import os
...
# Standard 10-K section boundaries (works for most filers)
SECTIONS = {
...
for year in YEARS:
    filepath = os.path.join(RAW_DIR, f"{TICKER.lower()}_10k_fy{year}.htm")
    print(f"\n=== Processing FY{year} ===")
